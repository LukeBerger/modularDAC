...
#' Helper to label the modules of a graph generated by make module graph
#' @param g an igraph object
#' @param n.nodes an integer determining the number of features/nodes in the graph
#' @param n.mods an integer determining the number of modules in output graph
#' @param mod.names a character vector of mod names
...
#' Generates simulated data modeling n.samples based on a network
#' @param g an igraph object
